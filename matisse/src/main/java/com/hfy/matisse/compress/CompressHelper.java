package com.hfy.matisse.compress;
...
public class CompressHelper {
    ...
    public static class Builder {
         ...
         * @param maxWidth  最大宽度
         */
        public CompressHelper.Builder setMaxWidth(float maxWidth) {
         ...
         */
        public CompressHelper.Builder setMaxHeight(float maxHeight) {
         ...
         * 设置压缩的后缀格式
         */
        public CompressHelper.Builder setCompressFormat(Bitmap.CompressFormat compressFormat) {
         ...
         * 设置Bitmap的参数
         */
        public CompressHelper.Builder setBitmapConfig(Bitmap.Config bitmapConfig) {
         ...
         */
        public CompressHelper.Builder setQuality(int quality) {
         ...
         */
        public CompressHelper.Builder setDestinationDirectoryPath(String destinationDirectoryPath) {
         ...
         * @param prefix    前缀
         */
        public CompressHelper.Builder setFileNamePrefix(String prefix) {
         ...
         * @param fileName  文件名
         */
        public CompressHelper.Builder setFileName(String fileName) {
