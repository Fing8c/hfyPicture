package com.hfy.matisse.internal.ui.adapter;
...
import com.hfy.matisse.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) { //拍照
            final View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.photo_capture_item, parent, false);
            final CaptureViewHolder holder = new CaptureViewHolder(v);
